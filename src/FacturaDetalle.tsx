// Extraído 2026-08-03 de Contalibra y Restolibra, donde este archivo era
// byte-idéntico (mismo md5, 530 líneas). Esa duplicación es la que hizo que el
// fix del medio "cuenta corriente" y el del período de servicio -- los dos del
// mismo día -- hubiera que aplicarlos dos veces.
//
// Lo único que difería entre los dos productos era de dónde sale el usuario
// para los chequeos de rol: cada uno arma su contexto con `createAuthContext`,
// así que el `useAuth` de este paquete NO es el mismo contexto que el del
// producto y leerlo desde acá daría siempre vacío. Por eso el rol entra como
// prop y no se importa.
      ...
      {loading || !detalle ? (
        ...
        <>
          ...
          <div className="flex flex-wrap justify-end gap-2">
            {esAdmin && [1, 6, 11].includes(detalle.factura.tipo) && (
              <>
            ...
            {esAdmin && !estaAutorizada(detalle.factura) && (
