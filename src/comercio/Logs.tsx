// La consola de actividad de los productos comerciales: la línea de tiempo de
// ventas, caja, stock, facturas, turnos, remitos y presupuestos, y los accesos.
// Alimentada por `libracore.logs_router` (P9-M4); es OTRA pantalla que la `Logs`
// de la raíz del kit, que consume `libraauth.auditoria` — ver el comentario de
// aquélla sobre por qué son dos.
//
// Extraída de `pages/Logs.tsx` de Contalibra y Restolibra (P9-M4, 2026-09-07):
// eran iguales salvo comentarios.
import { Fragment, useEffect, useMemo, useState } from 'react'
import { Link } from 'react-router-dom'
import { api, ApiError } from '../api-client'
import { type LogsData, type LogActividad } from './tipos'
