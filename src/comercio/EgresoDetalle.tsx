// El detalle de un egreso: los pagos registrados, el alta de un pago y la baja.
//
// Extraída de `pages/EgresoDetalle.tsx` de Contalibra y Restolibra (P9-M4, 2026-09-07):
...
import { TIPOS_COMPROBANTE, type Egreso, type PagoEgreso } from './tipos'
