// Las cuentas de tesorería con sus saldos, el alta, el movimiento y la transferencia.
//
// Extraída de `pages/Tesoreria.tsx` de Contalibra y Restolibra (P9-M4, 2026-09-07):
