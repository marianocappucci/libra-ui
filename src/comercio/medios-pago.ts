/** Los medios de pago de esta instancia, del backend (P9-M3).
 *
 *  Era `lib/medios-pago.ts`, byte a byte igual en Contalibra y Restolibra.
 *
 ...
 *  lista canónica no ofrecía— y le faltaban las tarjetas. Ocho pantallas por
 ...
 *  los que sí aceptaba. Una copia en el frontend siempre termina divergiendo,
 *  porque nada la compara con la del backend. Acá no hay lista: se pide.
 *
 *  Ver `wiki/concepts/medios-de-pago-familia-libra.md` y `libracore.medios_pago`.
 */
import { useEffect, useState } from 'react'

import { api } from '../api-client'
import { etiqueta as etiquetaDe, etiquetaCorta as etiquetaCortaDe } from '../medios-pago'
