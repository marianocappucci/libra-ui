// La ficha del proveedor con sus egresos, la edición inline y la baja.
//
// Extraída de `pages/ProveedorDetalle.tsx` de Contalibra y Restolibra (P9-M4, 2026-09-07):
...
import { type Egreso, type Proveedor } from './tipos'
