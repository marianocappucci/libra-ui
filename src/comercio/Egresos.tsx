// Los egresos: listado con resumen del período y filtros, y el alta en diálogo.
//
// Extraída de `pages/Egresos.tsx` de Contalibra y Restolibra (P9-M4, 2026-09-07).
// Lo que difería: Restolibra elegía la categoría con `SelectBuscable` (el `Select`
...
import { TIPOS_COMPROBANTE, type CategoriaEgreso, type Egreso, type Proveedor, type ResumenEgresos, opcionesProveedor, opcionesCategoriaPorNombre } from './tipos'
