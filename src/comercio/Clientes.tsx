// El listado de clientes con el alta en diálogo, la consulta de CUIT y la baja/reactivación.
//
// Extraída de `pages/Clientes.tsx` de Contalibra y Restolibra (P9-M4, 2026-09-07):
