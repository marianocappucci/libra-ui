// El detalle de un presupuesto: datos, ítems con totales, el ciclo de estados
// (enviar, aceptar, convertir a remito, rechazar, facturar) y el envío por email.
//
...
export function PresupuestoDetalle({
  conRemitoValorizado = false,
  urlDelPdf = (id: number) => `/presupuestos/${id}/pdf`,
}: {
  /** Ofrece además «Convertir a remito valorizado» (con los precios del
   *  presupuesto). Va de la mano de lo que el producto haga con `valorizado` en
   *  `convertir_a_remito`: Contalibra lo respeta, Restolibra lo ignora. */
  conRemitoValorizado?: boolean
    ...
    <div className="grid gap-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {p && <Button asChild size="sm" variant="outline"><a href={urlDelPdf(p.id)} target="_blank" rel="noreferrer"><FileDown />Ver PDF</a></Button>}
