// El alta de un remito: cliente (o nombre libre), ítems con autocompletado del
// catálogo, y el alta que redirige al detalle.
//
...
import { type ProductoBusqueda, opcionesCliente } from './comercio/tipos'
