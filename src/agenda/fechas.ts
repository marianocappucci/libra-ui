 ...
 *
 *  Lunes y no domingo: es la semana laboral, que es la que se agenda. */
 ...
 *  esto el formato dependería de dónde corra. Y una agenda se lee en 24 h —
 *  es la misma regla que el `dd-mm-aaaa` del resto de la familia. */
